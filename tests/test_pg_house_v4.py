# -*- coding: utf-8 -*-
"""
验证 sql/extract_house_number.sql 中 extract_house_number 函数对37个新地址样例的解析。

测试覆盖：
    1. 用户最新提供的 37 个地址样例（V4）
    2. V2 的 38 个样例回归
    3. V2 的 27 个回归样例回归
"""
import os
...
def main():
    ...
    # ========== 测试 1：V4 新样例（37 个） ==========
    p1, f1, fc1 = run_test_suite(cur, '测试 1：V4 新地址样例（37 个）', USER_SAMPLES_V4)

    # ========== 测试 2：V2 样例回归（38 个） ==========
    p2, f2, fc2 = run_test_suite(cur, '测试 2：V2 样例回归（38 个）', USER_SAMPLES_V2)

    # ========== 测试 3：原有回归样例（28 个） ==========
    p3, f3, fc3 = run_test_suite(cur, '测试 3：原有回归样例（28 个）', REGRESSION_SAMPLES)
